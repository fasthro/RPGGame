...
namespace RPGGame.Editor
{
    ...
    public class VirtualJoyEditor : UnityEditor.Editor
    {
        ...
        {   
            ...
            circleTexture = AssetDatabase.LoadAssetAtPath("Assets/Editor/VirtualJoyInspector/GUI/circle.png", typeof(Texture2D)) as Texture2D;
            squarTexture = AssetDatabase.LoadAssetAtPath("Assets/Editor/VirtualJoyInspector/GUI/square.png", typeof(Texture2D)) as Texture2D;
